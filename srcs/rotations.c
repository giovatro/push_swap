...
/*   Updated: 2024/01/04 11:11:53 by gtroiano         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
ft_rotate_type_ab calculates and decides which rotation combination 
is best to use to sort the stack. 
After rotation, there is always one push operation is left to do, 
which is embeded to code.
Function is used during push from A to B.

ft_rotate_type_ba calculates and decides which rotation combination 
is best to use to sort the stack. 
