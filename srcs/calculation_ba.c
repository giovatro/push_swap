...
/*   Updated: 2024/01/03 11:23:45 by gtroiano         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	ft_case_rrarrb_a(t_stack *a, t_stack *b, int c)
{
	...
	if (ft_find_place_a(a, c))
		i = last_element_size(a) - ft_find_place_a(a, c);
	if ((i < (last_element_size(b) - ft_find_index(b, c))) && ft_find_index(b, c))
		i = last_element_size(b) - ft_find_index(b, c);
	return (i);
}
