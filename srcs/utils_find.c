...
/*   Updated: 2024/01/03 11:36:32 by gtroiano         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/*
 ...
 In other words, it check what index number nbr_push will get after it is being pushed to the stack_b.

 ft_find_place_a finds the correct place of the number in stack_a.
 In other words, it check what index number nbr_push will get after it is being pushed to the stack_a.
